...
class CogVideoXPipeline(DiffusionPipeline, CogVideoXLoraLoaderMixin):
    ...
    def init_control_embeddings(self):
    ...
    def __call__(
        ...
        if not output_type == "latent":
            video = self.decode_latents(latents, sliced_decode=True)
...
class CogVideoXStreamingPipeline(CogVideoXPipeline):
    ...
    def generate_step(self, latents, control_emb, *, num_noise_groups, lcm_multiplier, num_warmup_steps, with_frame_cond, window_size,
                      inner_steps, timesteps_grouped, batch_size, do_classifier_free_guidance, prompt_embeds, image_rotary_emb, 
    ...
    def prepare_generation_context(
        ...
        return gen_config, gen_step_config, decode_config
