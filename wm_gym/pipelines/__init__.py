...
try:
    ...
    _import_structure["pipeline_cogvideox_gym"] = ["CogVideoXPipeline", "CogVideoXStreamingPipeline", "CogVideoXStreamingPipelinePCFG"]
...
if TYPE_CHECKING or DIFFUSERS_SLOW_IMPORT:
    try:
        ...
        from .pipeline_cogvideox_gym import CogVideoXPipeline, CogVideoXStreamingPipeline, CogVideoXStreamingPipelinePCFG
